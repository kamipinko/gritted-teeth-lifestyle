...
function CycleBlade({ days, dailyPlan }) {
  ...
  return (
    <section className="relative z-10 py-2 px-2 pointer-events-none min-h-[calc(100vh-7px)] overflow-hidden">
      {false && (
      ...
      <div>
        ...
        <div style={{ position: 'absolute', bottom: '6px', left: 0, width: '180vw', maxWidth: 'none', marginLeft: 'calc(-40vw - 80px)', transform: 'rotate(10deg) scale(0.5625)', transformOrigin: '34.4% 97.7%' }}>

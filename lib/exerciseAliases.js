...
// Hand-curated muscle lists for every exercise in the library.
// Generated from the current state of lib/exerciseLibrary.js by
// scripts/build_muscle_fixup.py (which uses a biomechanical name-
// based classifier). Future `npm run import:exercises` runs use
// this map to override wger's noisy muscle tagging — wger over-
// tags synergists (e.g., DUMBBELL CURL gets [biceps, shoulders,
// abs]; BARBELL SQUAT gets [hamstrings, glutes, abs] without
// quads). Keys are normalized exercise IDs, values are the
// correct muscle list. Applied BEFORE wger muscle mapping
// (overrides entirely).
export const MUSCLE_FIXUP = {
  "1-ARM HALF-KNEELING LAT PULLDOWN": ["back", "biceps"],
  "AB WHEEL": ["abs"],
  "ABDOMINAL CRUNCH": ["abs"],
  "ALTERNATING BICEPS CURLS WITH DUMBBELL": ["biceps"],
  "ALTERNATING DUMBBELL HAMMER CURL": ["biceps", "forearms"],
  "ALTERNATING HIGH CABLE ROW": ["back", "biceps"],
  "ARM RAISES (T/Y/I)": ["shoulders", "back"],
  "ASSISTED PULL-UP": ["back", "biceps"],
  "BARBELL AB ROLLOUT": ["abs"],
  "BARBELL HIP THRUST": ["glutes", "hamstrings"],
  "BARBELL LUNGES STANDING": ["quads", "glutes", "hamstrings"],
  "BARBELL ROMANIAN DEADLIFT (RDL)": ["hamstrings", "glutes", "back"],
  "BARBELL ROW (OVERHAND)": ["back", "biceps"],
  "BARBELL ROW (UNDERHAND)": ["back", "biceps"],
  "BARBELL SQUAT": ["quads", "glutes", "hamstrings"],
  "BARBELL STEP BACK LUNGE": ["quads", "glutes", "hamstrings"],
  ...
  "BICEPS CURLS WITH BARBELL": ["biceps"],
  "BICEPS CURLS WITH SZ-BAR": ["biceps"],
  "BICYCLE CRUNCHES": ["abs"],
  "BODYWEIGHT BICEPS CURL": ["biceps"],
  "BOX SQUAT": ["quads", "glutes"],
  "BULGARIAN SQUAT WITH DUMBBELLS": ["quads", "glutes"],
  "BUTTERFLY": ["chest"],
  "BUTTERFLY NARROW GRIP": ["chest"],
  "BUTTERFLY REVERSE": ["shoulders", "back"],
  "CABLE CHEST PRESS - DECLINE": ["chest", "shoulders", "triceps"],
  "CABLE CHEST PRESS - INCLINE": ["chest", "shoulders", "triceps"],
  "CABLE CONCENTRATION CURL": ["biceps"],
  "CABLE CROSS-OVER": ["chest", "shoulders"],
  "CABLE CURLS": ["biceps"],
  "CABLE EXTERNAL ROTATION": ["shoulders"],
  "CABLE FLY": ["chest", "shoulders"],
  "CABLE FLY LOWER CHEST": ["chest", "shoulders"],
  "CABLE FLY UPPER CHEST": ["chest", "shoulders"],
  "CABLE LATERAL RAISES (SINGLE ARM)": ["shoulders"],
  "CABLE PRESS AROUND": ["chest", "shoulders"],
  "CABLE PULL THROUGH": ["glutes", "hamstrings"],
  "CABLE REAR DELT FLY": ["shoulders", "back"],
  "CABLE SHRUG-IN": ["back"],
  "CABLE TRI EXTENSION - EXTERNAL ROTATION": ["triceps"],
  "CABLE TRI EXTENSION - INTERNAL ROTATION": ["triceps"],
  "CABLE TRICEP KICKBACK": ["triceps"],
  "CABLE TRICEPS PRESS": ["triceps"],
  "CABLE WOODCHOPPERS": ["abs"],
  "CALF PRESS USING LEG PRESS MACHINE": ["calves"],
  "CALF RAISES, ONE LEGGED": ["calves"],
  "CHEST-SUPPORTED REAR DELT RAISE": ["shoulders", "back"],
  "CHIN-UPS": ["back", "biceps"],
  "CLOSE-GRIP BENCH PRESS": ["triceps", "chest", "shoulders"],
  "CLOSE-GRIP LAT PULL DOWN": ["back", "biceps"],
  "CLOSE-GRIP PRESS-UPS": ["triceps", "chest", "shoulders"],
  "CROSS-BENCH DUMBBELL PULLOVERS": ["back", "chest"],
  "CROSS-BODY CABLE Y-RAISE": ["shoulders", "back"],
  "CRUNCHES ON MACHINE": ["abs"],
  "CRUNCHES WITH CABLE": ["abs"],
  "CRUNCHES WITH LEGS UP": ["abs"],
  "DB CROSS BODY HAMMER CURLS": ["biceps", "forearms"],
  "DB SKULL CRUSHERS": ["triceps"],
  "DEADLIFTS": ["back", "glutes", "hamstrings"],
  "DECLINE BENCH LEG RAISE": ["abs"],
  "DECLINE BENCH PRESS BARBELL": ["chest", "shoulders", "triceps"],
  "DECLINE BENCH PRESS DUMBBELL": ["chest", "shoulders", "triceps"],
  "DECLINE PUSHUPS": ["chest", "shoulders", "triceps"],
  "DEFICIT DEADLIFT": ["back", "glutes", "hamstrings", "quads"],
  "DEFICIT PUSH UPS": ["chest", "shoulders", "triceps"],
  "DIAMOND PUSH UPS": ["triceps", "chest", "shoulders"],
  "DIPS": ["chest", "triceps"],
  "DIPS BETWEEN TWO BENCHES": ["chest", "triceps"],
  "DOUBLE LEG CALF RAISE": ["calves"],
  "DRAG PUSHDOWN": ["triceps"],
  "DUMBBELL BENCH PRESS": ["chest", "shoulders", "triceps"],
  "DUMBBELL BENT OVER FACE PULL": ["shoulders", "back"],
  "DUMBBELL BENT OVER ROW": ["back", "biceps"],
  "DUMBBELL CLOSE GRIP BENCH PRESS": ["triceps", "chest", "shoulders"],
  "DUMBBELL CONCENTRATION CURL": ["biceps"],
  "DUMBBELL CRUNCHES": ["abs"],
  "DUMBBELL CURL": ["biceps"],
  "DUMBBELL FRONT SQUAT": ["quads", "glutes"],
  "DUMBBELL GOBLET SQUAT": ["quads", "glutes"],
  "DUMBBELL HIP THRUST": ["glutes", "hamstrings"],
  "DUMBBELL INCLINE CURL": ["biceps"],
  "DUMBBELL LUNGES STANDING": ["quads", "glutes", "hamstrings"],
  "DUMBBELL LUNGES WALKING": ["quads", "glutes", "hamstrings"],
  "DUMBBELL PULLOVER": ["back", "chest"],
  "DUMBBELL REAR DELT ROW": ["shoulders", "back"],
  "DUMBBELL REAR LUNGE": ["quads", "glutes", "hamstrings"],
  "DUMBBELL ROMANIAN DEADLIFT": ["hamstrings", "glutes", "back"],
  "DUMBBELL SCAPTION": ["shoulders"],
  "DUMBBELL SIDE BEND": ["abs"],
  "DUMBBELL SINGLE-LEG HIP THRUST": ["glutes", "hamstrings"],
  "DUMBBELL THRUSTER": ["quads", "glutes", "shoulders", "triceps"],
  "DUMBBELL TRICEPS EXTENSION": ["triceps"],
  "DUMBBELL UPRIGHT-ROW": ["shoulders", "back"],
  "FACEPULL": ["back", "shoulders"],
  "FLOOR SKULL CRUSHER": ["triceps"],
  "FLUTTER KICKS": ["abs"],
  "FLY WITH DUMBBELLS": ["chest", "shoulders"],
  "FLY WITH DUMBBELLS, DECLINE BENCH": ["chest", "shoulders"],
  "FRONT PLATE RAISE": ["shoulders"],
  "FRONT PULL NARROW": ["back", "biceps"],
  "FRONT PULL WIDE": ["back", "biceps"],
  "FRONT RAISE (CABLE)": ["shoulders"],
  "FRONT RAISES": ["shoulders"],
  "FRONT SQUATS": ["quads", "glutes"],
  "GLUTE BRIDGE": ["glutes", "hamstrings"],
  "GLUTE DRIVE": ["glutes", "hamstrings"],
  "GLUTE KICKBACK (MACHINE)": ["glutes", "hamstrings"],
  "GOOD MORNINGS": ["hamstrings", "glutes", "back"],
  "HACK SQUATS": ["quads", "glutes"],
  "HAMMER CURL": ["biceps", "forearms"],
  "HAMMERCURLS ON CABLE": ["biceps", "forearms"],
  "HAMMERSTRENGTH DECLINE CHEST PRESS": ["chest", "shoulders", "triceps"],
  "HANGING LEG RAISES": ["abs"],
  "HIGH ROW": ["back", "biceps"],
  "HIGH-CABLE LATERAL RAISE": ["shoulders"],
  "HIGH-INCLINE SMITH MACHINE PRESS": ["shoulders", "chest", "triceps"],
  "HYPEREXTENSIONS": ["back", "glutes", "hamstrings"],
  "INCLINE BENCH PRESS - BARBELL": ["chest", "shoulders", "triceps"],
  "INCLINE BENCH PRESS - DUMBBELL": ["chest", "shoulders", "triceps"],
  "INCLINE BENCH REVERSE FLY": ["shoulders", "back"],
  "INCLINE CHEST-SUPPORTED DUMBBELL ROW": ["biceps", "back"],
  "INCLINE CLOSE GRIP BARBELL BENCH PRESS": ["triceps", "shoulders", "chest"],
  "INCLINE CRUNCHES": ["abs"],
  "INCLINE DB Y-RAISE": ["shoulders", "back"],
  "INCLINE DUMBBELL FLY": ["chest", "shoulders"],
  "INCLINE DUMBBELL ROW": ["back", "biceps"],
  "INCLINE OHP DB": ["shoulders", "chest", "triceps"],
  "INCLINE PUSH UP": ["chest", "shoulders", "triceps"],
  "INCLINE SKULL CRUSH": ["triceps"],
  "INCLINE SMITH PRESS": ["shoulders", "chest", "triceps"],
  "INVERTED LAT PULL DOWN": ["back", "biceps"],
  "INVERTED ROWS": ["back", "biceps"],
  "JM PRESS": ["triceps", "chest"],
  "KNEE PUSH-UPS": ["shoulders", "chest", "triceps"],
  "KNEE RAISES": ["abs"],
  "KROC ROW": ["back", "biceps"],
  "LANDMINE PRESS": ["shoulders", "chest", "triceps"],
  "LAT PULL DOWN": ["back", "biceps"],
  "LAT PULLDOWN (WIDE GRIP)": ["back", "biceps"],
  "LAT PULLDOWN - CROSS BODY SINGLE ARM": ["back", "biceps"],
  "LATERAL RAISES": ["shoulders"],
  "LATERAL ROWS ON CABLE, ONE ARMED": ["back", "biceps"],
  "LEG CURLS (LAYING)": ["hamstrings"],
  "LEG CURLS (SITTING)": ["hamstrings"],
  "LEG CURLS (STANDING)": ["hamstrings"],
  "LEG EXTENSION": ["quads"],
  "LEG PRESS": ["quads", "glutes", "hamstrings"],
  "LEG PRESS TOE PRESS": ["calves"],
  "LEG PRESSES (NARROW)": ["quads", "glutes"],
  "LEG PRESSES (WIDE)": ["quads", "glutes", "hamstrings"],
  "LEG RAISE": ["abs"],
  "LEG RAISES, STANDING": ["abs"],
  "LEVERAGE MACHINE ISO ROW": ["back", "biceps"],
  "LONG-PULLEY (LOW ROW)": ["back", "biceps"],
  "LYING TRICEPS EXTENSIONS": ["triceps"],
  "LYING TRICEPS KICKBACK": ["triceps"],
  ...
  "OMNI CABLE CROSS-OVER": ["chest", "shoulders"],
  "ONE ARM OVERHEAD CABLE TRICEP EXTENSION": ["triceps"],
  "ONE ARMED PUSH-UPS": ["chest", "shoulders", "triceps"],
  "OVERHAND CABLE CURL": ["biceps", "forearms"],
  "OVERHEAD CABLE TRICEP EXTENSION": ["triceps"],
  "OVERHEAD PRESS": ["shoulders", "triceps"],
  "OVERHEAD TRICEPS EXTENSION": ["triceps"],
  "PALLOF PRESS": ["abs"],
  "PENDELAY ROWS": ["back", "biceps"],
  "PENDULUM SQUAT": ["quads", "glutes"],
  "PIKE PUSH UPS": ["shoulders", "triceps"],
  "PREACHER CURL - EXTERNALLY ROTATED": ["biceps"],
  "PREACHER CURL - INTERNALLY ROTATED": ["biceps"],
  "PREACHER CURLS": ["biceps"],
  "PULL-UPS": ["back", "biceps"],
  "PULL-UPS (NEUTRAL GRIP)": ["back", "biceps"],
  "PULL-UPS (WIDE GRIP)": ["back", "biceps"],
  "PULLOVER MACHINE": ["back", "chest"],
  "PUSH PRESS": ["shoulders", "triceps", "quads"],
  "PUSH-UPS": ["chest", "shoulders", "triceps"],
  "PUSH-UPS | DECLINE": ["chest", "shoulders", "triceps"],
  "PUSH-UPS | INCLINE": ["chest", "shoulders", "triceps"],
  "PUSH-UPS | PARALLETTES": ["chest", "shoulders", "triceps"],
  "RACK DEADLIFT": ["back", "glutes", "hamstrings"],
  "REAR DELT RAISE": ["shoulders", "back"],
  "RENEGADE ROW": ["back", "biceps"],
  "REVERSE CRUNCH": ["abs"],
  "REVERSE CURL": ["biceps", "forearms"],
  "REVERSE EZ BAR CABLE CURLS": ["biceps", "forearms"],
  "REVERSE FLY STANDING": ["shoulders", "back"],
  "REVERSE GRIP BENCH PRESS": ["chest", "triceps", "shoulders"],
  "REVERSE HYPEREXTENSION": ["back", "glutes", "hamstrings"],
  "REVERSE NORDIC CURL": ["quads"],
  "REVERSE PREACHER CURL (CLOSE GRIP)": ["biceps", "forearms"],
  "REVERSE WOOD CHOPS": ["abs"],
  "ROTARY TORSO MACHINE": ["abs"],
  "ROWING SEATED, NARROW GRIP": ["back", "biceps"],
  "SEATED CABLE MID TRAP SHRUG": ["back"],
  "SEATED CABLE ROWS": ["back", "biceps"],
  "SEATED DUMBBELL CALF RAISE": ["calves"],
  "SEATED DUMBBELL CURLS": ["biceps"],
  "SEATED DUMBBELL SIDE LATERAL": ["shoulders"],
  "SEATED HIP ABDUCTION": ["glutes"],
  "SEATED HIP ADDUCTION": ["quads", "glutes"],
  "SEATED KNEE TUCK": ["abs"],
  "SEATED MACHINE ROW": ["back", "biceps"],
  "SEATED TRICEPS PRESS": ["triceps"],
  "SEATED V-GRIP ROW": ["back", "biceps"],
  "SHOTGUN ROW": ["back", "biceps"],
  "SHOULDER EXTERNAL ROTATION WITH DUMBBELL": ["shoulders"],
  "SHOULDER INTERNAL ROTATION (CABLE)": ["shoulders"],
  "SHOULDER PRESS (DUMBBELL)": ["shoulders", "triceps"],
  "SHOULDER PRESS, ON MACHINE": ["shoulders", "triceps"],
  "SHRUGS, BARBELLS": ["back"],
  "SHRUGS, DUMBBELLS": ["back"],
  "SIDE CRUNCH": ["abs"],
  "SIDE DUMBBELL TRUNK FLEXION": ["abs"],
  "SIDE LATERAL RAISE (CABLE)": ["shoulders"],
  "SIDE LATERAL RAISE - BACK (CABLE)": ["shoulders"],
  "SIDE LATERAL RAISE - FRONT (CABLE)": ["shoulders"],
  "SIDE STRAIGHT-ARM PULLDOWN (CABLE)": ["back"],
  "SINGLE LEG EXTENSION": ["quads"],
  "SINGLE LEG GLUTE BRIDGE": ["glutes", "hamstrings"],
  "SINGLE-ARM PREACHER CURL": ["biceps"],
  "SINGLE-LEG DEADLIFT WITH DUMBBELL": ["hamstrings", "glutes", "back"],
  "SIT-UPS": ["abs"],
  "SITTING CALF RAISES": ["calves"],
  "SKULLCRUSHER SZ-BAR": ["triceps"],
  "SMITH MACHINE CLOSE-GRIP BENCH PRESS": ["triceps", "chest", "shoulders"],
  "SMITH MACHINE SPLIT SQUAT": ["quads", "glutes"],
  "SMITH MACHINE SQUAT": ["glutes", "quads"],
  "SPIDER CURL": ["biceps"],
  "STANDING CALF RAISES": ["calves"],
  "STANDING SIDE CRUNCHES": ["abs"],
  "STIFF-LEGGED DEADLIFTS": ["hamstrings", "glutes", "back"],
  "STRAIGHT BAR CABLE FRONT RAISE": ["shoulders"],
  "STRAIGHT-ARM PULL DOWN (BAR ATTACHMENT)": ["back"],
  "STRAIGHT-ARM PULL DOWN (ROPE ATTACHMENT)": ["back"],
  "SUMO DEADLIFT": ["glutes", "hamstrings", "back", "quads"],
  "SUMO SQUATS": ["quads", "glutes", "hamstrings"],
  "SUPERMAN": ["glutes", "back"],
  "T-BAR ROW": ["back", "biceps"],
  "THRUSTER": ["quads", "glutes", "shoulders", "triceps"],
  "TRAP BAR SQUAT": ["quads", "glutes", "hamstrings"],
  "TRAP-3 RAISE": ["shoulders", "back"],
  "TRICEP DUMBBELL KICKBACK": ["triceps"],
  "TRICEP ROPE PUSHDOWNS": ["triceps"],
  "TRICEPS DIPS (ASSISTED)": ["triceps"],
  "TRICEPS EXTENSIONS ON CABLE": ["triceps"],
  "TRICEPS PUSHDOWN": ["triceps"],
  "TRUNK ROTATION WITH CABLE": ["abs"],
  "UNDERHAND LAT PULL DOWN": ["back", "biceps"],
  "UPRIGHT ROW, SZ-BAR": ["shoulders", "back"],

...
// Strength-relative XP normalization anchor (R1a). All load calculations
// scale entered_weight by (REFERENCE_BW / user_BW) so that a 100 lb person
// and a 300 lb person earn identical XP for the same 1× BW lift. Reference
// is system-wide constant — same number for every user.
export const REFERENCE_BW = 180  // lb

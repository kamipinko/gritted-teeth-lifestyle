...
// Hand-curated muscle list overrides for exercises wger tags with absurd
// muscle combinations. Keys are normalized exercise IDs, values are the
// correct muscle list. Applied AFTER wger muscle mapping and BEFORE
// FOREARMS_OVERLAY substring matching.
export const MUSCLE_FIXUP = {
  'BARBELL WRIST CURL':  ['biceps', 'forearms'],  // wger tagged [shoulders, hamstrings, biceps, abs] — nonsense
}

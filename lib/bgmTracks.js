...
// Used by the home-page singleton on creation. Honours the random-on-launch
// flag — if set, picks a random track at launch without overwriting the
// stored preference (so flipping the flag off restores the user's pick).

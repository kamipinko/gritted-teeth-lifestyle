...
const SOUND_MAP = {
  'card-hover':       '/sounds/card-hover.wav',
  'card-tap':         '/sounds/card-tap.wav',
  'card-confirm':     '/sounds/card-confirm.wav',
  'transition-slash': '/sounds/transition-slash.wav',
  'button-hover':     '/sounds/button-hover.wav',
  'button-confirm':   '/sounds/nier-confirm.wav',
  'menu-open':        '/sounds/menu-open.wav',
  'menu-close':       '/sounds/return.wav',
  'option-select':    '/sounds/nier-clips.wav',
  'stamp':            '/sounds/stamp.wav',
  'char-stamp':       '/sounds/stamp.wav',
  'char-erase':       '/sounds/chime-ping.wav',
  'mega-transition':  '/sounds/mega-transition.wav',
  'brand-confirm':    '/sounds/explosion.wav',
